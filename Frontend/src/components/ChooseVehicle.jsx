...
const ChooseVehicle = () => {
  ...
  return (
    <div className=" w-full flex justify-center items-center flex-col absolute bottom-0 px-0 gap-3 py-4 rounded-t-2xl bg-black transition-opacity duration-300 ">
      <div className="w-full flex flex-col items-center justify-center gap-4 px-3 py-1">
        {vehicle.map((vehicle, index) => (
          <React.Fragment key={index}>
            <div className="w-full py-3 px-2 rounded-lg flex gap-2 items-center justify-center border-2 border-gray-300">
