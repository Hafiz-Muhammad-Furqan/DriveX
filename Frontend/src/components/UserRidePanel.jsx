...
const UserRidePanel = ({
  ...
  return (
    <div
      className={`w-full flex justify-center items-center flex-col  px-3 sm:px-4 gap-5 pt-4 pb-6 sm:pb-4 rounded-t-3xl  bottom-0 absolute bg-black transition-transform duration-200 ease-linear z-[2] ${
